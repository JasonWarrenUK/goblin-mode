...
<!-- Library/module: -->
## API / Exports
{{ the public surface, with usage examples }}

<!-- Config/infra: -->
## What it configures
{{ what each file controls, how to modify safely, dependencies }}

<!-- Commands/scripts: -->
## Commands
{{ what each does, arguments, an example invocation each }}

## Key Files
{{ files someone new needs first, one line each }}
