...
**Goblin Mode** is a permanently-in-flux configuration system (skills, agents, hooks) built by one developer to solve problems they actually had. Every skill traces back to a specific friction point; the hooks enforce habits that were being skipped.

> [!NOTE]
> This setup is specific to one developer's workflow (and brain). If you're building your own, the **process** transfers; the specifics should be yours. Start with [Building Your Own](docs/guides/building-your-own.md).
...
| **Skills (model-invocable command)** | 22 | Command skills the model can also self-invoke |
