...
reads: tldr-first, core sections only if the tldr earned it
skips: deep-dive sections, on principle
trigger: having to read past the tldr for the basic concept, or a gap only the refused section would have filled
