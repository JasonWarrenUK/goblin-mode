...
| Layer | Description |
|---|---|
| Client/UI | React components, hooks, pages |
| Server/API | Express routes, middleware, handlers |
| SDK/Core | Core libraries, SDK wrappers |
| Agent/Logic | Business logic, agents, processors |
