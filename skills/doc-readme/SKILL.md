...
8. **Marker comment**, placed as the very first line of the file: `<!-- doc-readme: generated {date}. Delete this line once you hand-edit this file. -->`, which is what lets a future run detect state (b) instead of treating a since-regenerated README as hand-authored.
