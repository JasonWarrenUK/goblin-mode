...
For the full generated list with descriptions, see **[skills/README.md](../../skills/README.md)** (regenerated from frontmatter, see [below](#regenerating-the-index)); this page deliberately doesn't duplicate its rows.
